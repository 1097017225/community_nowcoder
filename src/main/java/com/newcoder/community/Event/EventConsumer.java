...
public class EventConsumer implements CommunityConstant {
    ...
    public void handleShareMessage(ConsumerRecord record) {
        ...
        //启动定时器,监视图片生成
        UploadTack tack = new UploadTack(fileName, suffix);
        Future future = taskScheduler.scheduleAtFixedRate(tack, 500);
        tack.setFuture(future);

    }

    class UploadTack implements Runnable {
        ...
        public UploadTack(String fileName, String suffix) {
